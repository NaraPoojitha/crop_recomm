...
if 'page' in st.session_state and st.session_state['page'] == 'fertilizer_recommendation':
    ...
    # Add content specific to Fertilizer Recommendation Page
...
if 'page' in st.session_state and st.session_state['page'] == 'crop_yield_prediction':
    st.write("## Crop Yield Prediction Page")
    # Add content specific to Crop Yield Prediction Page
    # Add your crop yield prediction logic here
